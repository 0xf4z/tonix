  ...
  wayland.windowManager.niri = {
    ...
    settings = {
      input = {
        ...
        # Unsupported/unknown in this form:
        # max-scroll-amount = "0%";
      };
      ...
      # Unsupported with the current niri-nix KDL generation:
      #
      # outputs."eDP-1" = {
      ...
      binds = {
        ...
        # Kept commented because swaylock may not be installed:
        #
        # "Super+Alt+L" = {
        ...
        # Unsupported/removed in newer Niri:
